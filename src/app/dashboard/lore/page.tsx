                      ...
                      <div className="grid grid-cols-1 lg:grid-cols-1 gap-8">
                        <div className="space-y-6">
                          ...
                          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                            ...
                            <label className="block group">
                              <span className="mb-1.5 block text-xs font-bold uppercase tracking-wider text-[var(--text-secondary)] transition-colors group-focus-within:text-red-500">
                              ...
                              <input
                                ...
                                className="w-full rounded-xl border border-[var(--border-ui)] bg-[var(--background-app)] px-3 py-2 text-sm text-[var(--text-primary)] outline-none transition-all focus:border-red-500/50 focus:ring-2 focus:ring-red-500/20 shadow-sm"
                              />
                            </label>
